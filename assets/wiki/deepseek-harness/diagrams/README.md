...
| 顺序 | 主题 | 类型 | 交互图 | Spec |
| --- | --- | --- | --- | --- |
| 01 | 一次用户请求的执行顺序 | Architecture | [HTML](13-one-turn-through-dsh.html) | [JSON](13-one-turn-through-dsh.architecture.json) |
| 02 | 一项能力对谁生效、何时撤销 | Architecture | [HTML](14-space-time-composition.html) | [JSON](14-space-time-composition.architecture.json) |
