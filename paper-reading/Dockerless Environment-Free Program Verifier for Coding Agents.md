...
这篇论文的切口就是：如果 rollout 已经可以 env-free 地收集，能不能把 verifier 也做成 env-free？

![Dockerless 与其他 verifier 的设计对比](https://aka.doubaocdn.com/s/1kCJ1wrdjl)

## 方法 Pipeline

![Dockerless 两阶段验证架构](https://aka.doubaocdn.com/s/pXUr1wrdjh)
